...
tryCatch({
  ...
  harvest_data <- read_dta_auto("secta3i_harvestw4", input_dir, temp_dir)
  perennial_data <- read_dta_auto("secta3iii_harvestw4", input_dir, temp_dir)
...
tryCatch({
  ...
  cover_data <- read_dta_auto("secta_plantingw4", input_dir, temp_dir)
...
tryCatch({
  ...
  indiv0_data <- read_dta_auto("sect1_harvestw4", input_dir, temp_dir)
  indiv_data <- read_dta_auto("sect1_plantingw4", input_dir, temp_dir)
...
tryCatch({
  ...
  csption_data <- read_dta_auto("totcons_final", input_dir, temp_dir)
...
tryCatch({
  ...
  meta_data <- read_dta_auto("aux_harvestw4", input_dir, temp_dir)
...
tryCatch({
  ...
  labor_hh_data <- read_dta_auto("sect3_plantingw4", input_dir, temp_dir)
...
tryCatch({
  ...
  indiv_roster_data <- read_dta_auto("sect1_plantingw4", input_dir, temp_dir)
...
tryCatch({
  ...
  indiv_roster1_data <- read_dta_auto("sect2_harvestw4", input_dir, temp_dir)
...
tryCatch({
  ...
  housing_data <- read_dta_auto("sect11_plantingw4", input_dir, temp_dir)
...
tryCatch({
  ...
  livestock_data <- read_dta_auto("sect11i_plantingw4", input_dir, temp_dir)
...
tryCatch({
  ...
  shocks_data <- read_dta_auto("sect15a_harvestw4", input_dir, temp_dir)
...
tryCatch({
  ...
  nfe_data <- read_dta_auto("sect9a_harvestw4", input_dir, temp_dir)
...
tryCatch({
  ...
  items_data <- read_dta_auto("secta4_harvestw4", input_dir, temp_dir)
...
tryCatch({
  ...
  items_hh_data <- read_dta_auto("sect5_plantingw4", input_dir, temp_dir)
...
tryCatch({
  ...
  tenure_data <- read_dta_auto("sect11b1_plantingw4", input_dir, temp_dir)
...
tryCatch({
  ...
  plot_roster_data <- read_dta_auto("sect11a1_plantingw4", input_dir, temp_dir)
...
tryCatch({
  ...
  geovars_hh_data <- read_dta_auto("nga_householdgeovars_y4", 
...
tryCatch({
  ...
  seeds_data <- read_dta_auto("sect11f_plantingw4", input_dir, temp_dir)
...
tryCatch({
  ...
  harvest_raw <- read_dta_auto("secta3i_harvestw4", input_dir, temp_dir)
...
tryCatch({
  ...
  geovars_data <- read_dta_auto("nga_plotgeovariables_y4", 
                                file.path(Input_path, country, wave), 
                                temp_dir)
...
tryCatch({
  ...
  harvest_sold_data <- read_dta_auto("secta3ii_harvestw4", input_dir, temp_dir)
...
# 6.5 Inorganic fertilizer
tryCatch({
  cat("  Extracting fertilizer variables...\n")
  
  ferts_data <- read_dta_auto("secta11c2_harvestw4", input_dir, temp_dir)
...
tryCatch({
  ...
  lab_roster11 <- read_dta_auto("sect11c1a_plantingw4", input_dir, temp_dir)
  lab_roster12 <- read_dta_auto("sect11c1b_plantingw4", input_dir, temp_dir)
  ...
  # Harvest labor
  lab_roster21 <- read_dta_auto("secta2a_harvestw4", input_dir, temp_dir)
  lab_roster22 <- read_dta_auto("secta2b_harvestw4", input_dir, temp_dir)
...
tryCatch({
  ...
  anthropo_data <- read_dta_auto("sect4a_harvestw4", input_dir, temp_dir)
...
tryCatch({
  ...
  hdds_data <- read_dta_auto("sect10b_harvestw4", input_dir, temp_dir)
